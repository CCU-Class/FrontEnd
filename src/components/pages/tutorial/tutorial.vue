<template>
  <div
    class="w-full bg-gradient-to-b from-orange-50 to-white py-16 border-b border-orange-100">
    <div class="max-w-4xl mx-auto px-4 text-center">
      <h1
        class="text-4xl md:text-5xl font-extrabold tracking-tight mb-4">
        <span
          class="bg-clip-text text-transparent bg-gradient-to-r from-orange-400 to-red-600">
          CCU Class
        </span>
      </h1>
...
const arrange = ref([
  ...
  },
  {
    title: "以時間搜尋課程",
    content:
      "為了讓大家更方便尋找空堂時間的課程，我們提供了以時間搜尋課程的功能。開啟模式後，直接在課表上拖拉選擇時間，右鍵確認後即可搜尋。",
  },
  {
    title: "浮動搜尋欄",
    content:
      "當使用者在下方課表區域時，左邊會有一個可以縮放的浮動搜尋欄，可以在此直接搜尋課程並加入課表，操作更流暢。",
  },
  {
    title: "課程評價查看",
    content:
      "本站與 CCU Plus 合作，提供課程評價功能。在課表點擊課程翻轉後，或在搜尋欄選擇課程前，皆可查看該課程的真實評價。",
  },
]);
...
const make = ref([
  {
    title: "課表儲存",
    content:
      "只要在同一裝置的同瀏覽器，您的所有課表資訊都會自動保存，下次開啟時直接載入，無須重複操作。",
  },
  {
    title: "課表分享",
    content:
      "點選分享課表會產生一個專屬網址，您可以將其分享給朋友。該網址僅供查看，他人無法修改您的課表內容。",
  },
  {
    title: "多課表製作",
    content:
      "為了方便安排多種選課方案（如 Plan A / Plan B），或紀錄朋友的課表，您可以在此新增多個課表並自由切換。",
  },
  {
    title: "課表美化",
    content:
      "點擊課表上的課程將其翻轉，在背面的功能表內可以自定義格子顏色與文字顏色，打造獨一無二的個人化課表。",
  },
  {
    title: "學分計算",
    content:
      "開啟「顯示學分」功能，系統會自動計算目前課表中的學分總數（不含自定義課程），幫助您掌握學分狀況。",
  },
]);
