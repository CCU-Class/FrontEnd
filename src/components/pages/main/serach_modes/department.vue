        ...
        <div class="">
            <div class = "w-full flex justify-between">
                <div class="mx-12 w-4/12">
                    ...
                    <ul class = "mx-auto result-show overflow-y-auto overflow-x-hidden z-10" ref = "department_search_list" v-show="show_department">
                        <li v-for="item in department_data" class = "w-full bg-white/70 px-3 py-1 hover:bg-orange-300 hover:text-white" 
