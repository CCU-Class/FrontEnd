    ...
    <div>
      <div class="w-full px-3 md:w-8/12 mx-auto pb-9">
        <div class="py-6 text-center">
          <router-link to="/main" class="btn-link"> > 開始使用 </router-link>
        </div>
        <div class="text-orange-300 font-semibold text-3xl">初次見面?</div>
      ...
      <div class="w-11/12 md:w-7/12 mx-auto my-3">
        ...
        <div class="bg-orange-100/50 py-6 px-3 flex flex-row">
          ...
          <div>
            ...
            <p class="px-6 py-3 text-xl">
              中正大學通訊工程學系三年級， 主要研究網頁前後端與演算法競賽。 2023
              中研院 Summer intern
            </p>
          </div>
        </div>
        <div class="bg-orange-100/50 py-6 px-3 flex flex-row">
          ...
          <div>
            ...
            <p class="px-6 py-3 text-xl">
              中正大學資訊工程學系三年級 主要研究軟體工程、網頁前後端、競程，
              目前主要學習ML， 此專案主要負責後端伺服器、資料庫、API。
            </p>
          </div>
        </div>
        <div class="bg-orange-100/50 py-6 px-3 flex flex-row">
