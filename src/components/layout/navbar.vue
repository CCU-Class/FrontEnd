...
<template>
  ...
  >
    ...
    <div class="text-md hidden md:block">
      ...
      <router-link to="/tutorial" class="btn-head"> 使用教學 </router-link>
      <router-link to="/main" class="btn-head"> 開始使用 </router-link>
    </div>
  ...
  <div class="z-0 block w-full bg-orange-200 md:hidden" v-if="view === 2">
    <div class="grid grid-cols-1 w-10/12 mx-auto text-left">
      ...
      <router-link to="/main" class="btn-head-mobile"> 開始使用 </router-link>
    </div>
  </div>
</template>
